...
func (m *MockDataServiceSuccessful) ReadMany(page int, rowsPerPage int, ctx context.Context) ([]*models.Data, error) {
    return []*models.Data{
        {ID: 1, DeviceID: "device1", DeviceName: "device1", Reading: 1.0, Type: "type1", DateTime: "2021-01-01T00:00:00Z", Description: "description1"},
...
func (m *MockDataServiceSuccessful) ValidateData(data *models.Data) error { return nil }
...
func (m *MockDataServiceNotFound) ReadOne(id int, ctx context.Context) (*models.Data, error) { return nil, nil }
func (m *MockDataServiceNotFound) Create(data *models.Data, ctx context.Context) error        { return nil }
...
func (m *MockDataServiceNotFound) ValidateData(data *models.Data) error { return nil }
...
func (m *MockDataServiceError) Create(data *models.Data, ctx context.Context) error { return DataError{Message: "Error creating data."} }
...
func (m *MockDataServiceError) ValidateData(data *models.Data) error { return nil }
